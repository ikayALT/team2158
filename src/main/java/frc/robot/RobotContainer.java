...
public class RobotContainer {
  ...
  private final moveRobot moveRobotSub = new moveRobot();
  private final SpinMotor spinMotorCmd = new SpinMotor(spinMotorSub);
  private final IncreaseSpeed increaseSpeedCmd = new IncreaseSpeed(spinMotorSub, moveRobotSub);

  // Replace with CommandPS4Controller or CommandJoystick if needed
  //private final CommandJoystick m_driverController = new CommandJoystick(OperatorConstants.kDriverControllerPort);
  private final Trigger shootTrigger = new JoystickButton(IncreaseSpeed.kJoystick, 1);
